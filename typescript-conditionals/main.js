...
// Ex. 3
const startsWithJ = (string) => string[0].toUpperCase() === 'J';
...
const person = { name: 'Jesus Rodriguez-Luna', age: 24 };
...
const homer = { name: 'Homer Jay Simpson', age: 39 };
...
const johnDoe = { name: 'John Doe', age: 34 };
